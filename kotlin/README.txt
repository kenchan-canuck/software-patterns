Purpose
=======
    This repository contains sample codes in various Kotlin
languages to implement a variety of Software Patterns which would 
maximize code reuse.

    The examples use a variety of more advanced Kotlin linguistic
features such as Generic Types and nested inner classes along with
Kotlin Collections to realize a variety of Software Patterns such as 
...
practicality of leveraging advanced Kotlin linguistic features 
...
1. kotlinc *.kt -include-runtime -d <executable>.jar

2. java -jar <executable>.jar
