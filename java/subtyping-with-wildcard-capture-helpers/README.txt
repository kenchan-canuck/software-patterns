...
wildcard capture helpers to implement a simpler generic API.

    The value of these sample codes is to demonstrate the simplicity 
of implementing a generic API with parameter and return types
using wildcard types to wrap the internal method calls that use
