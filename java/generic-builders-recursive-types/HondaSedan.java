...
public class HondaSedan extends Sedan { 

   private String has4wd = "not sure";
 
   public static class Builder<T extends Builder<T>> extends Sedan.Builder<T> {
       ...
       @Override
       public HondaSedan build() {
          return new HondaSedan(this);
       }
   ...
   protected HondaSedan(Builder<?> builder) {
       super(builder);
