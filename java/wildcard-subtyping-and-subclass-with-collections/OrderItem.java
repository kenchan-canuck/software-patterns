...
public class OrderItem<T extends Item<T>> extends Item<T> {
    ...
    @Override
    public OrderItem<T> add_quantity() { super.add_quantity(); return self(); }
 
    public OrderItem<T> name(String nm) { name = nm; return self(); }

    @SuppressWarnings("unchecked")
    public OrderItem<T> self() { return this; }
    ...
    public static void main(String[] args) {
       ...
       OrderItem<?> order_item2 = order_item1.add_quantity().add_quantity();
       Order<?> order1 = new Order<>();
       Order<?> order2 = order1.add_item(order_item2);
