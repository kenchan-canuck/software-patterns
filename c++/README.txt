Purpose
=======
    This repository contains sample codes in various C++
languages to implement a variety of Software Patterns which would 
maximize code reuse.

    The examples use a variety of more advanced C++ linguistic
features such as Generic Types and nested inner classes along with
C++ Collections to realize a variety of Software Patterns such as 
...
practicality of leveraging advanced C++ linguistic features 
...
1. g++ -c *.cpp  (to compile the c++ source code)

2. g++ -o <program name> *.o
