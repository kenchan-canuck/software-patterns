Purpose
=======
    This repository contains sample codes in various Swift
...
practicality of leveraging advanced Swift linguistic features
...
1. swiftc -o Test Test.swift (to compile and to generate an executable)
