Purpose
=======
    This repository contains sample codes in various Scala
languages to implement a variety of Software Patterns which would 
maximize code reuse.

    The examples use a variety of more advanced Scala linguistic
features such as Generic Types and nested inner classes along with
Scala Collections to realize a variety of Software Patterns such as 
...
practicality of leveraging advanced Scala linguistic features 
